...
const Layout: React.FC = ({children}) => {
  return (
    <div className='flex min-h-screen bg-gray-200 flex-col'>
      <div className='flex justify-center py-2 text-3xl font-semibold text-gray-700 shadow font-serif'>
        Spotify Personal Playlist
      </div>
      <div className='flex-1 flex justify-center gap-2 py-12 px-4'>
        {children}
      </div>
